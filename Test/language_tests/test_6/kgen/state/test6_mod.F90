...
! Generated at: 2015-07-31 10:22:47
! KGEN version: 0.4.12
    ...
    MODULE test6_mod
        ...
        SUBROUTINE test_6()
            ...
            IF ( ANY(kgen_counter == kgen_counter_at) ) THEN
                ...
                kgen_filepath = "/glade/p/work/amogh/kgen_dev/KGen/Test/language_tests/test_6/kgen/kernel/add." // TRIM(ADJUSTL(kgen_counter_conv))
        ...
        ! write subroutines
            SUBROUTINE kgen_write_real_4_dim1(var, kgen_unit, indexes, printvar)
                ...
                IF ( is_true ) THEN
                    ...
                    END IF
                END IF
            END SUBROUTINE kgen_write_real_4_dim1
