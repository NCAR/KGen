...
! Generated at: 2015-08-04 10:50:03
! KGEN version: 0.4.13
    ...
    MODULE test1_mod
        ...
        do n=1,niter
                ...
                IF ( ANY(kgen_counter == kgen_counter_at) ) THEN
                    ...
                    kgen_filepath = "/glade/p/work/amogh/kgen_dev/git_kgen/KGen/Test/unit_tests/test_1/kgen/kernel/compute_add." // TRIM(ADJUSTL(kgen_counter_conv))
