...
! KGEN version: 0.5.0
    ...
    USE kernel, ONLY : kgen_write_mod2 => kgen_write
        USE kernel
        USE types_mod
        ...
        SUBROUTINE calling_subroutine()
            ...
            IF ( ANY(kgen_counter == kgen_counter_at) ) THEN
                ...
                kgen_filepath = "/glade/p/work/amogh/kgen_dev/git_kgen/KGen/Test/unit_tests/tmp_complex_datatypes/kernel/add." // TRIM(ADJUSTL(kgen_counter_conv))
