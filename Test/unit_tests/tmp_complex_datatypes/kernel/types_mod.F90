...
! KGEN version: 0.5.0
    ...
    SUBROUTINE kgen_read_complex_type(var, kgen_unit, printvar)
        ...
        END IF
    END SUBROUTINE
    RECURSIVE SUBROUTINE kgen_verify_level_3(varname, check_status, var, ref_var)
        ...
        END IF
    END SUBROUTINE
    RECURSIVE SUBROUTINE kgen_verify_elem_mimic(varname, check_status, var, ref_var)
        CHARACTER(*), INTENT(IN) :: varname
        TYPE(check_t), INTENT(INOUT) :: check_status
        TYPE(check_t) :: dtype_check_status
        ...
        END IF
    END SUBROUTINE
    RECURSIVE SUBROUTINE kgen_verify_elem_mimic2(varname, check_status, var, ref_var)
        CHARACTER(*), INTENT(IN) :: varname
        TYPE(check_t), INTENT(INOUT) :: check_status
        TYPE(check_t) :: dtype_check_status
        ...
        END IF
    END SUBROUTINE
    RECURSIVE SUBROUTINE kgen_verify_complex_type(varname, check_status, var, ref_var)
        CHARACTER(*), INTENT(IN) :: varname
        TYPE(check_t), INTENT(INOUT) :: check_status
        TYPE(check_t) :: dtype_check_status
