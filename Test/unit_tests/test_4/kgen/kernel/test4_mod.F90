...
! Generated at: 2015-08-04 10:50:20
! KGEN version: 0.4.13
    ...
    MODULE test4_mod
        ...
        SUBROUTINE test_4(kgen_unit)
            ...
            REAL(KIND=real_kind) :: array_3(arraysize)
            REAL(KIND=real_kind) :: ref_array_3(arraysize)
            REAL(KIND=real_kind) :: array_2(arraysize)
            tolerance = 1.E-14
            CALL kgen_init_check(check_status, tolerance)
            READ(UNIT=kgen_unit) array_1
            READ(UNIT=kgen_unit) array_3
            READ(UNIT=kgen_unit) array_2

            READ(UNIT=kgen_unit) ref_array_3


            ! call to kernel
                call add(array_1, array_2, array_3)
            ! kernel verification for output variables
            CALL kgen_verify_real_real_kind_dim1( "array_3", check_status, array_3, ref_array_3)
        ...
        ! write subroutines
            SUBROUTINE kgen_read_real_real_kind_dim1(var, kgen_unit, printvar)
                INTEGER, INTENT(IN) :: kgen_unit
                ...
                IF ( is_true ) THEN
                    ...
                    END IF
                END IF
            END SUBROUTINE kgen_read_real_real_kind_dim1


        ! verify subroutines
            SUBROUTINE kgen_verify_real_real_kind_dim1( varname, check_status, var, ref_var)
                ...
                END IF
            END SUBROUTINE kgen_verify_real_real_kind_dim1
