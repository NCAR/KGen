...
import glob
import shutil
from kapp_sys_ys_mpas_pgi_test import KAppSysYSMpasPgiTest

class Test(KAppSysYSMpasPgiTest):
    ...
    def generate(self, myname, result):
        ...
        passed, out, err = self.extract_kernel(srcfile, None, \
            ...
            __cmd_build='"cd %s; ./build_core_pgi.sh"'%tmpsrc, \
            __cmd_run='"cd %s; bsub < run_core_pgi.sh"'%tmpsrc, \
            ...
            __outdir=workdir)
            #__rebuild='all',
            #__kernel_compile='PRERUN="module load pgi/16.5"',
        ...
        if passed:
            result[myname]['statefiles'] = [ \
				'atm_dyn_tend_work.0.0.5', 'atm_dyn_tend_work.31.0.5', 'atm_dyn_tend_work.63.0.5', \
				'atm_dyn_tend_work.0.0.10', 'atm_dyn_tend_work.31.0.10', 'atm_dyn_tend_work.63.0.10']
