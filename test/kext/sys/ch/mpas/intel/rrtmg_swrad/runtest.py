...
class Test(KExtSysCHMpasIntelTest):
    ...
    def generate(self, myname, result):
        ...
        srcfile = '%s/src/core_atmosphere/physics/mpas_atmphys_driver_radiation_sw.F'%tmpsrc
        namepath = 'mpas_atmphys_driver_radiation_sw:driver_radiation_sw:rrtmg_swrad'
        fc = 'ifort'
        ...
        if passed:
            result[myname]['statefiles'] = glob.glob('rrtmg_swrad.*.*.*')
