...
#from configparser import ConfigParser # KGEN deletion
from ConfigParser import ConfigParser # KGEN addition
...
class DoitMain(object):
    ...
    def load_config_ini(filenames):
        ...
        """
        #cfg_parser = ConfigParser(allow_no_value=True, delimiters=('=',)) # KGEN deletion
        cfg_parser = ConfigParser(allow_no_value=True) # KGEN addition
